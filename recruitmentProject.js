...
// couverture), harnais d'évaluation du classement (nDCG@5 0,995 sur 30 cas
// annotés) et audit de biais par contrefactuels (ratio d'impact 0,868 → 1,000).
...
export const recruitmentProject = {
  fr: {
    ...
    metrics: [
      { value: "895", label: "tests automatisés", detail: "83 % de couverture, exécutés en intégration continue" },
...
+ écarts            analyse rédigée
    ...
    challenges: {
      ...
      items: [
        ...
        { label: "Un seuil parfait qu'il ne fallait effectivement pas croire", detail: "Sur sept cas annotés, le balayage donnait 100 % de précision et de rappel à 85 % — mais sur une marge d'un seul point, et le README avertissait de ne pas y croire. En portant le jeu à trente cas et 132 profils, la séparation parfaite disparaît : le seuil optimal descend à 73 % et retient encore quinze profils à tort. Le moteur n'a pas changé ; le jeu est devenu assez grand pour montrer ce qu'il faisait déjà." },
    ...
    impact: {
      ...
      items: [
        ...
        { label: "Biais de localisation neutralisé", detail: "Ratio d'impact ramené de 0,868 à 1,000 par le screening à l'aveugle, mesuré avant et après sur 396 comparaisons de rang." },
        ...
        { label: "Le coût d'une pondération est visible avant de l'appliquer", detail: "Baisser le poids des compétences de 0,45 à 0,20 dégrade le ratio d'impact de 0,868 à 0,846 sans qu'on ait touché au poids de la localisation : quand les compétences cessent de départager, les critères restants décident. Cette entrée annonçait auparavant une chute à 0,714, sous le seuil légal — vrai sur sept cas annotés, faux sur trente. L'effet spectaculaire était un artefact du petit effectif, et c'est le jeu élargi qui l'a révélé." },
    ...
    screenshots: [
      ...
      { file: "recruitment-agent.png", caption: "Un agent qui prepare et propose : 26 % de propositions contredites, 36 % sur les rejets contre 15 % sur les entretiens" },
      { file: "recruitment-replay.png", caption: "Les decisions passees recalculees : l'ecart vient du moteur 1.1.0, pas des donnees — et il aurait fait basculer le dossier" },
      { file: "recruitment-silence.png", caption: "Ce qu'on n'a pas dit aux candidats : un dossier ecarte sur deux n'a jamais recu de reponse" },
      { file: "recruitment-channels.png", caption: "Quatre canaux, trois etats : connecte, modelise sans fournisseur, ou hors logiciel — et le consentement avant le message" },
      { file: "recruitment-arabic-rtl.png", caption: "Interface en arabe : la mise en page se retourne, les echelles de mesure non — un axe de 0 a 100 % ne se lit pas en miroir" },
    ],
  ...
  en: {
    ...
    metrics: [
      { value: "895", label: "automated tests", detail: "83% coverage, run in continuous integration" },
...
+ skill gaps        written analysis
    ...
    challenges: {
      ...
      items: [
        ...
        { label: "A perfect threshold that indeed should not have been believed", detail: "On seven annotated cases the sweep gave 100 % precision and recall at 85 % — over a margin of a single point, and the README warned against believing it. Growing the set to thirty cases and 132 profiles makes the perfect split vanish: the optimal threshold drops to 73 % and still retains fifteen profiles wrongly. The engine did not change; the set grew large enough to show what it was already doing." },
    ...
    impact: {
      ...
      items: [
        ...
        { label: "Location bias neutralised", detail: "Impact ratio brought from 0.868 to 1.000 by blind screening, measured before and after across 396 rank comparisons." },
        ...
        { label: "The price of a weighting is visible before applying it", detail: "Lowering the weight of skills from 0.45 to 0.20 degrades the impact ratio from 0.868 to 0.846 without touching the weight of location: when skills stop separating candidates, the remaining criteria decide. This entry previously announced a drop to 0.714, below the legal threshold — true on seven annotated cases, false on thirty. The dramatic effect was an artefact of the small sample, and the enlarged set is what revealed it." },
    ...
    screenshots: [
      ...
      { file: "recruitment-agent.png", caption: "An agent that prepares and proposes: 26 % of proposals contradicted, 36 % on rejections against 15 % on interviews" },
      { file: "recruitment-replay.png", caption: "Past decisions recomputed: the gap comes from engine 1.1.0, not from the data — and it would have flipped the file" },
      { file: "recruitment-silence.png", caption: "What candidates were never told: one rejected file in two never got an answer" },
      { file: "recruitment-channels.png", caption: "Four channels, three states: connected, modelled without a provider, or outside the software — and consent before the message" },
      { file: "recruitment-arabic-rtl.png", caption: "Arabic interface: the layout flips, measurement scales do not — an axis from 0 to 100 % is not read mirrored" },
    ],
    repoUrl: "https://github.com/baDrsh531/ai-recruitment-assistant",
